...
% Lagrangian dynamics
pi_sndrd_sym = sym('pi%d%d', [70,1], 'real'); % standard parameters
Lagr = beta_Lf*pi_sndrd_sym; % Lagrangian of the system
P = [beta_P(1,:), beta_P(2,:), beta_P(3,:), beta_P(4,:),...
     beta_P(5,:), beta_P(6,:), beta_P(7,:)]*pi_sndrd_sym; % Potential energy
